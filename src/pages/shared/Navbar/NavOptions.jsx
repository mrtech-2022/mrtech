...
export const SecurityNavOptions = () => (
    <ul onClick={toggleDrawer} className="nested-dropdown-content absolute top-0 left-full -ml-6 mt-1 md:w-48 shadow-2xl space-y-2 rounded-lg bg-white py-2 text-black">
...
export const ServerNavOptions = () => (
    <ul onClick={toggleDrawer} className="nested-dropdown-content absolute top-0 left-full -ml-32 lg:-ml-6 mt-1 md:w-48 shadow-2xl space-y-2 rounded-lg bg-white py-2 text-black">
...
export const AccessoriesNavOptions = () => (
    <ul onClick={toggleDrawer} className="nested-dropdown-content absolute top-0 left-full -ml-[70px]  lg:-ml-6 mt-1 md:w-48 shadow-2xl space-y-2 rounded-lg bg-white py-2 text-black">
...
export const StorageNavOptions = () => (
    <ul onClick={toggleDrawer} className="nested-dropdown-content absolute top-0 left-full -ml-20 lg:-ml-6 mt-1 md:w-48 shadow-2xl space-y-2 rounded-lg bg-white py-2 text-black">
